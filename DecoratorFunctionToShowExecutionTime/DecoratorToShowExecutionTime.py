...
#     ambi1999@gmail.com
# Demo code to show an example of decorator function 
# to show execution time of other functions.
# 
# Code also shows the efficiency of NumPy which is 
...
def timer(func):
    ...
    def wrapper(*args,**kwargs):
        ...
        print(f"Function {func.__name__!r} has finished execution. \n****Execution time of {func.__name__!r} function equals to {executionTime} millisecondss")
        return result
    return wrapper
